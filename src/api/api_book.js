...
export default {
  ...
  // //查询配置管理/用户管理删除用户
  // deluser:params =>{
  //   return API.POST('/userinfo/delete',params)
  // },
  // //查询配置管理/用户管理批量导入
  // batchimportantuser:params =>{
  //   return API.POST('/userinfo/insertUsers',params)
  // },

  // // //查询配置管理/图书书架和罚金标准共用设置获取数据
  // setshelf:params =>{
  //   return API.POST('/mange/list',params)
  // },
  // //查询配置管理/图书书架设置修改和罚金标准共用设置修改数据
  // updateshelf:params =>{
  //   return API.POST('/mange/update',params)
  // },
  // //查询配置管理/图书类别删除类别
  // delshelfcategory:params =>{
  //   return API.POST('/mange/delete',params)
  // },
  // //查询配置管理/图书类别删除类别
  // insertregion:params =>{
  //   return API.POST('/mange/insert',params)
  // },
  
  // //查询记录查询获取列表(通过page分页)
  // recordList: params => {
  //   return API.POST('/record/list', params)
  // },
  ...
  // //归还图书页面罚金缴纳归还按钮
  // recordback: params => {
  //   return API.POST('/record/back', params)
  // },
  ...
  //   return API.POST('/books/list', params)
  // },
  // //借阅图书页面借出操作
  // lendbook: params => {
  //   return API.POST('/record/lend', params)
  // },
  ...
  // // //图书库存页面新增图书数据
  // addbookstock: params => {
  //   return API.POST('/books/add', params)
  // },
  // // //图书库存页面修改图书数据
  // editbookstock: params => {
  //   return API.POST('/books/update', params)
  // },
  // // //图书库存页面处理图书数据
  // bookdeal: params => {
  //   return API.POST('/bookDeal/add', params)
  // },
  // // //图书库存页面批量修改图书数据
  // bookbatch: params => {
  //   return API.POST('/books/updates', params)
  // },
  // //首页图书处理弹框列表数据信息
  // dealtipList : params =>{
  //   return API.POST('/bookDeal/list',params)
  // },
  // //首页列表选项数据信息
  // indextabList : params =>{
  //   return API.POST('/report/libInfoSort',params)
  // },
  // //首页数据展示请求
  // indexlibinfo : params =>{
  //   return API.POST('/report/libInfo',params)
  // },
